  ...
  return (
    <div className="mx-auto max-w-2xl py-4 sm:py-8 lg:py-16 ">
      ...
      <input
        ...
        className="px-2 mb-8 block max-w-2xl w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
      />
